...
public class KompSorgu extends JFrame {
	...
	public KompSorgu() throws SQLException{
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(choice.getSelectedIndex()==2) {
					...
					Object[] columnNames = {"�slem ID", "�slem Tipi", "�slem TC", "Kan Grubu", "Kan Aldigi TC", "SSN", "tarih"};
		...
		choice.add("Hem Kan Al�p Hem Kan Veren Ki�iler");
		choice.add("X Kan Grubundaki �nite Say�s� (Bo� B�rak�l�rsa B�t�n Kan Gruplar� G�sterilecek)");	
		choice.add("Covid ge�irmi� gen�-yeti�kin veya 2020 y�l�nda K�z�lay'a ba�vurmu� ki�ilerin ad, soyad ve kimlik numaralar�n� listeleyiniz.");
