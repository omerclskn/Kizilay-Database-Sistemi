				...
				try {
					...
					try {
						if(s.getWarnings() == null) {
							...
							SQLWarning errorText = s.getWarnings(); // error k�sm�n� bast�r�yor
							String errortxt = errorText.getMessage(); // error k�sm�n� bilerek sadece SQL'den d�nen RAISE bast�r�yor.
